...
(* OASIS_START *)
(* DO NOT EDIT (digest: d8fe2884a98dc78db7587332730f03db) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "A System F omega compiler (LLVM based)";
          description = None;
          categories = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("llvm",
                               Some (OASISVersion.VGreaterEqual "3.4"));
                           FindlibPackage ("llvm.irreader", None);
                           FindlibPackage ("llvm.passmgr_builder", None);
                           FindlibPackage ("llvm.target", None);
                           FindlibPackage ("llvm.bitwriter", None);
                           FindlibPackage ("llvm.all_backends", None);
                           FindlibPackage ("llvm.linker", None);
                           FindlibPackage
                             ("batteries",
                               Some (OASISVersion.VGreaterEqual "2.2"));
                           FindlibPackage ("monomorphic", None)
                        ];
                      ...
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-w"; "A-44-33-4"])];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-w"; "A-44-33-4"])]
                   },
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "cZd\220~\174\160\029\222\144y\195\173\189\220\151";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
