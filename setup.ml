...
(* OASIS_START *)
(* DO NOT EDIT (digest: fbabcf228398d4fb9e984a70c113e57d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "A System F omega compiler";
          description = None;
          categories = [];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("monad-exn", None)];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "^\199\218\148!\140s\022U4\207\028\249\133\166*";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
